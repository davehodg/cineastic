use utf8;
package Cineastic::Schema::Result::MovieGenre;
...
Related object: L<Cineastic::Schema::Result::Genre>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZXfVJLrWU/V05dkksr5YPQ
